...
helpMessage ="""❝【ᴢɪᴀᴅ~ｄｅｓυ SelfBot Command 】❞
❂͜͡☆➣ 『Help』
❂͜͡☆➣ 『Creator』
❂͜͡☆➣ 『Gcreator』
❂͜͡☆➣ 『Leave group:』
...
============================
₡₡『OPEN ORDER』₡₡
➣1K Folls Instagram Only 20K
➣Self Bot(Free Custom) Only 20K//Month
➣1K Likes Only 15K
➣1K Likes Indo Only 20K
➣1k Views Youtube 15K
➣Open Order Protection Bot
➣➣ 15K:1 Grub/Bulan
➣➣ 25K:3 Grub/Bulan
「Payment 」:
❂XL(Kebutuhan Sosmed)
...
#--------------------------------------------------------
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Yang Bikin Bot Ini Senpai :3")
#--------------------------------------------------------
